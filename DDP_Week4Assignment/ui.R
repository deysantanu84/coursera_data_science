...
shinyUI(
    navbarPage(
        ...
        tabPanel(
            "About",
            h3("Developing Data Products - Assignment Week 4 - Shiny Application and Reproducible Pitch"),
            h3("Author: Santanu Dey - 12th September, 2017"),
            br(),
            ...
            p("Source code of this application is available at",
              a(href = "https://github.com/deysantanu84/DDP_Week4Assignment",
                "https://github.com/deysantanu84/DDP_Week4Assignment")
            )
        )
    )
)
